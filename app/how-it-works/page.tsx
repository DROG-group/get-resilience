...
export default function HowItWorksPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-dark-50 mb-4">How It Works</h1>
      ...
      <div className="mb-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark-50">Create or Join a Council</h2>
        </div>
        <div className="ml-16">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card p-5">
              <h3 className="font-semibold text-dark-50 mb-2">Create a Council</h3>
            ...
            <div className="card p-5">
              <h3 className="font-semibold text-dark-50 mb-2">Join a Council</h3>
              <ul className="text-sm text-dark-400 space-y-1.5">
      ...
      <div className="mb-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark-50">Document & Report</h2>
        </div>
        <div className="ml-16">
          <p className="text-dark-300 mb-4">
            When you see a platform violation, document it with our structured reporting form.
          </p>
          <div className="bg-dark-800 rounded-xl p-6 space-y-4 border border-dark-700">
            <div className="flex items-start gap-3">
              <span className="text-brand-400 font-bold mt-0.5">A.</span>
              <div>
                <p className="font-medium text-dark-50">Select the platform</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-dark-50">Paste the content URL</p>
                <p className="text-sm text-dark-400">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-dark-50">Categorize the violation</p>
                <p className="text-sm text-dark-400">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-dark-50">Upload evidence</p>
                <p className="text-sm text-dark-400">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-dark-50">Assign to your council</p>
                <p className="text-sm text-dark-400">
      ...
      <div className="mb-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark-50">Coordinated EU Action</h2>
        </div>
        <div className="ml-16">
          <p className="text-dark-300 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="card p-5 text-center">
              ...
              <h3 className="font-semibold text-dark-50 text-sm mb-1">Pattern Detection</h3>
            ...
            <div className="card p-5 text-center">
              <div className="text-2xl mb-2">&#x1F4E8;</div>
              <h3 className="font-semibold text-dark-50 text-sm mb-1">Coordinated Submission</h3>
              <p className="text-xs text-dark-400">
            ...
            <div className="card p-5 text-center">
              <div className="text-2xl mb-2">&#x2696;</div>
              <h3 className="font-semibold text-dark-50 text-sm mb-1">Enforcement</h3>
              <p className="text-xs text-dark-400">
      ...
      {/* CTA */}
      <div className="bg-gradient-to-br from-brand-400 to-brand-700 text-white rounded-2xl p-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/register"
            className="bg-white text-dark font-bold px-8 py-3 rounded-lg hover:bg-dark-50 transition-colors"
          >
            Create Account
          </Link>
          <Link
